...
### [Reg Commercial Team] — Tab: `SHP & TTS PC2`
...
|---|---|---|
| `[Weekly Live View]` | [Weekly Live View] SHP vs TTS ADG ADO | TBD |
| `[Reg Commercial Team]` | [Reg Commercial Team] Platform PC 2 Data | TBD |
| `[Reg CNLS copy]` | (Reg CNLS copy) SHP vs TTS ADG ADO Absolutes | TBD |
| `[Archive]` | [Reg CNLS] Archive Platform SOB & PC2 | TBD |
